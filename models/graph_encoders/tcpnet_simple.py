...
from topotein.models.graph_encoders.layers.tcpnet.interaction_simple import TCPInteractions
from topotein.models.graph_encoders.layers.tcpnet.embedding_simple import TCPEmbedding
